...
import { DeployToProjectPopup } from '@/components/shared/DeployToProjectPopup';
...
export function DeploymentControls({
	...
	const [isDeployToProjectOpen, setIsDeployToProjectOpen] = useState(false);
	const [isDeploy, setIsDeploy] = useState(false);
	const [deployData, setDeployData] = useState<Record<string, any>>({});
		...
		switch (state) {
			...
			case DeploymentState.READY_TO_DEPLOY:
				return {
					...
					subtitle: "It's Free! Deploys to FlexiFunnels Cloud Server",
			...
			case DeploymentState.DEPLOYING:
				return {
					...
					title: 'Deploying to FlexiFunnels',
					subtitle:
			...
			case DeploymentState.REDEPLOYING:
				return {
					...
					titleColor: 'text-blue-900 dark:text-blue-100',
					subtitleColor: 'text-blue-600 dark:text-blue-300',
					title: 'Redeploying to FlexiFunnels',
					subtitle:
	...
	return (
		<div className="space-y-3 deployment-controls">
				...
				>
					<div className="flex items-center gap-3">
						...
						<Button
							...
							onClick={() => setIsDeployToProjectOpen(true)}
						>
							{isCurrentlyDeploying ? (
								<>
			...
			{currentState === DeploymentState.DEPLOYED && isDeploy && (
				<div
					ref={deploymentRef}
					...
					<div className="flex items-center gap-3 mb-3">
						...
						<div className="flex-1">
							...
							<div className="text-xs text-green-700 dark:text-green-300 mt-0.5">
								Your application is now live on FlexiFunnels
								Cloud Server
							</div>
						</div>
					</div>
			...
			<DeployToProjectPopup
				open={isDeployToProjectOpen}
				onOpenChange={setIsDeployToProjectOpen}
